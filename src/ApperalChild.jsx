...
export default function ApperalChild({ setProductId }) {
  ...
  let finalCat = finalCategory.map((categories, index) => (
  ...
  let finalPro = finalProducts.map((products, index) => (
    <ChildProducts key={index} productdataprops={products} handleAddToCart={handleAddToCart} />
  ));
        ...
        <div className="product-info mb-1 bg-[#f5f5f5] rounded-[5px] shadow-[0_-2px_5px_0_rgb(0_0_0/_0%),_0_2px_5px_0_rgb(0_0_0/_15%)]">
          ...
          <div className="product-des px-[14px] py-[18px]">
            ...
            <div className="mt-3 ">
                ...
                <button onClick={()=>handleAddToCart(productdataprops.id)}
